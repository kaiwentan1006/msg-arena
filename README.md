...
![Version](https://img.shields.io/github/v/release/your-org/MSG-Arena?label=version&color=blue)
...
```bash
docker run -d -p 3000:3000 -v haven_data:/data ghcr.io/your-org/msg-arena:latest
```
...
[One-click cloud deploy on Zeabur](https://zeabur.com/templates?repoURL=https://github.com/your-org/MSG-Arena) · [on RepoCloud](https://repocloud.io/details/MSG-Arena/) · [Full setup guide](GUIDE.md)
...
| | |
|---|---|
| 🖥️ **[MSG Arena Desktop](https://github.com/your-org/MSG-Arena-Desktop/releases/latest)** | Windows and Linux. Per-app audio sharing (send one app’s sound, nothing else), device switching mid-call, native notifications, tray. It can also **run the server itself**. |
| 📱 **[MSG Arena for Android](https://play.google.com/store/apps/details?id=com.msgarena.app&gl=US)** | On Google Play. Native, not a web wrapper. Full chat, voice and push notifications. Also installable from your server's Download page. |
...
**Want to look around first?** The [community server](https://your-domain.example)
