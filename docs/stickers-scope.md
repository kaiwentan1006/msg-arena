...
Server-hosted stickers that can be sent as standalone messages anywhere in MSG Arena where the emoji picker is accessible: main channel, sub-channels, DMs (fullscreen and PiP), Threads (docked and PiP).
