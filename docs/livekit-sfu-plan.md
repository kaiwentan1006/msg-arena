...
LiveKit wins on operational simplicity, which is the deciding factor for MSG Arena's "self-host on a $5 VPS" audience. Per ancsemi's comment in #76: "LiveKit ships as one binary — operationally simpler for self-hosters."
