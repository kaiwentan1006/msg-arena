...
```bash
docker pull ghcr.io/kaiwentan1006/msg-arena:latest
docker run -d -p 3000:3000 -v haven_data:/data ghcr.io/kaiwentan1006/msg-arena:latest
```

**Option B — Build from source**:
```bash
git clone https://github.com/kaiwentan1006/MSG-Arena.git
cd MSG-Arena
docker compose up -d
```
...
> **Looking for ready-made bots and webhooks?** The community library at [**kaiwentan1006/MSG-Arena-community**](https://github.com/kaiwentan1006/MSG-Arena-community) collects user-contributed integrations you can deploy as-is — a GitHub releases poster, etc. PRs welcome there if you've built one of your own. See its [`CONTRIBUTING.md`](https://github.com/kaiwentan1006/MSG-Arena-community/blob/main/CONTRIBUTING.md) for how to submit.
