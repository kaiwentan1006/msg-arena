...
![Version](https://img.shields.io/github/v/release/kaiwentan1006/MSG-Arena?label=version&color=blue)
...
```bash
docker run -d -p 3000:3000 -v haven_data:/data ghcr.io/kaiwentan1006/msg-arena:latest
```
...
[One-click cloud deploy on Zeabur](https://zeabur.com/templates?repoURL=https://github.com/kaiwentan1006/MSG-Arena) · [on RepoCloud](https://repocloud.io/details/MSG-Arena/) · [Full setup guide](GUIDE.md)
...
| | |
|---|---|
| 🖥️ **[MSG Arena Desktop](https://github.com/kaiwentan1006/MSG-Arena-Desktop/releases/latest)** | Windows and Linux. Per-app audio sharing (send one app’s sound, nothing else), device switching mid-call, native notifications, tray. It can also **run the server itself**. |
...
**Want to look around first?** The [community server](https://msg-arena.up.railway.app)
