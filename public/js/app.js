...
import SocketMethods   from './modules/app-socket.js?v=4.4.4';
import UIBindMethods   from './modules/app-ui.js?v=4.4.4';
import MediaMethods    from './modules/app-media.js?v=4.4.4';
import ContextMethods  from './modules/app-context.js?v=4.4.4';
import ChannelMethods  from './modules/app-channels.js?v=4.4.4';
import MessageMethods  from './modules/app-messages.js?v=4.4.4';
import UserMethods     from './modules/app-users.js?v=4.4.4';
import VoiceMethods    from './modules/app-voice.js?v=4.4.4';
import UtilityMethods  from './modules/app-utilities.js?v=4.4.4';
import AdminMethods    from './modules/app-admin.js?v=4.4.4';
import PlatformMethods from './modules/app-platform.js?v=4.4.4';
import SearchMethods   from './modules/app-search.js?v=4.4.4';
import FerryMethods    from './modules/app-ferry.js?v=4.4.4';
import LfgMethods      from './modules/app-lfg.js?v=4.4.4';
import GamesMethods    from './modules/app-games.js?v=4.4.4';
import SquadsMethods   from './modules/app-squads.js?v=4.4.4';
import ClipMethods     from './modules/app-clips.js?v=4.4.4';
import TournamentMethods from './modules/app-tournaments.js?v=4.4.4';
import LeaderboardMethods from './modules/app-leaderboards.js?v=4.4.4';
import EventMethods     from './modules/app-events.js?v=4.4.4';
