// ═══════════════════════════════════════════════════════════
// MSG Arena — Main Client Application
// Features: chat, voice, themes, images, multi-server,
//           notifications, volume sliders, status bar
// ═══════════════════════════════════════════════════════════

import SocketMethods   from './modules/app-socket.js?v=4.7.15';
import UIBindMethods   from './modules/app-ui.js?v=4.7.15';
import MediaMethods    from './modules/app-media.js?v=4.7.15';
import ContextMethods  from './modules/app-context.js?v=4.7.15';
import ChannelMethods  from './modules/app-channels.js?v=4.7.15';
import MessageMethods  from './modules/app-messages.js?v=4.7.15';
import UserMethods     from './modules/app-users.js?v=4.7.15';
import VoiceMethods    from './modules/app-voice.js?v=4.7.15';
import UtilityMethods  from './modules/app-utilities.js?v=4.7.15';
import AdminMethods    from './modules/app-admin.js?v=4.7.15';
import PlatformMethods from './modules/app-platform.js?v=4.7.15';
import SearchMethods   from './modules/app-search.js?v=4.7.15';
import FerryMethods    from './modules/app-ferry.js?v=4.7.15';
import LfgMethods      from './modules/app-lfg.js?v=4.7.15';
import GamesMethods    from './modules/app-games.js?v=4.7.15';
import SquadsMethods   from './modules/app-squads.js?v=4.7.15';
import ClipMethods     from './modules/app-clips.js?v=4.7.15';
import TournamentMethods from './modules/app-tournaments.js?v=4.7.15';
import LeaderboardMethods from './modules/app-leaderboards.js?v=4.7.15';
import EventMethods     from './modules/app-events.js?v=4.7.15';
...
class HavenApp {
  constructor() {
    ...
    // Bundled image emoji shipped with MSG Arena (rendered like custom emoji but
  ...
  _init() {
    ...
    this._setupSquads?.();
    this._setupClips?.();
    this._setupTournaments?.();
    this._setupLeaderboards?.();
    this._setupEvents?.();
