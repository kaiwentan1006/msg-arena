...
// Set your own push-relay Cloud Function URL here (or via env). This must NOT be a
// third party's project — otherwise message previews would leave your server.
const DEFAULT_RELAY = 'https://your-push-relay.example/sendPush';
