...
# Run: curl -fsSL https://your-org.github.io/MSG-Arena/install.sh | bash
#  or: wget -qO- https://your-org.github.io/MSG-Arena/install.sh | bash
# ═══════════════════════════════════════════════════════════
set -e
...
if [ "$(uname -s)" = "Linux" ]; then
    ...
    if [ "$_ARCH" = "x86_64" ] || [ "$_ARCH" = "aarch64" ]; then
        ...
        echo "    https://github.com/your-org/MSG-Arena/releases/latest"
...
if [ -f "$INSTALL_DIR/package.json" ]; then
    ...
    if command -v git &> /dev/null; then
        ...
        git clone --depth 1 https://github.com/your-org/MSG-Arena.git "$INSTALL_DIR"
    else
        echo "        Downloading ZIP from GitHub..."
        TMP_ZIP=$(mktemp /tmp/haven-XXXXXX.zip)
        curl -fsSL "https://github.com/your-org/MSG-Arena/archive/refs/heads/main.zip" -o "$TMP_ZIP"
