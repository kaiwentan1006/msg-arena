...
if %ERRORLEVEL% EQU 0 (
    ...
    git clone --depth 1 https://github.com/your-org/MSG-Arena.git "%INSTALL_DIR%" 2>nul
...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "$ProgressPreference = 'SilentlyContinue';" ^
  "Invoke-WebRequest -Uri 'https://github.com/your-org/MSG-Arena/archive/refs/heads/main.zip' -OutFile $zip -UseBasicParsing;" ^
